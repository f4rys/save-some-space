    ...
    <>
      ...
      <div className="px-2 my-2 scrollable-text-container">
        ...
        >
          ...
          <p>
            This service is a straightforward URL shortening service designed to
            make your long, unwieldy links more manageable and shareable.
          ...
          <ul>
            <li>
              <strong>Frontend:</strong> React, a popular JavaScript library for
              building user interfaces, combined with Vite for fast development
          ...
          <ul>
            ...
            <li>
              User-Friendly Interface: A clean and intuitive interface makes the
              service easy to use.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              information, such as IP addresses and session cookies, to provide
              the service and ensure its security.
            </li>
            <li>
          ...
          <p>
            ...
            <a href="https://github.com/f4rys/Save-some-space">GitHub</a>. Feel
          ...
          <p>
            Hi, I&apos;m Wojciech Bartoszek, the creator of{" "}
            <i>save some space.</i> I&apos;m passionate about building web
            applications and exploring new technologies. This project was a fun
            way to learn more about React, Express.js, and MongoDB.
          </p>
