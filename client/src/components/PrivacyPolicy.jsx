    ...
    <>
      ...
      <div className="px-2 my-2 scrollable-text-container">
        ...
        >
          ...
          <p>
            The following information may be collected when you use the Service:
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Cookies:</strong> Session cookies are used to provide you
              the basic functionalities of the Service. These cookies are
          ...
          <p>
            The collected information is used to temporarily store newly created
            shortened links in cookies, in order to provide the basic
          ...
          <p>
            ...
            You can also object to the processing of your data or request its
            portability. To exercise these rights, please contact me at the
